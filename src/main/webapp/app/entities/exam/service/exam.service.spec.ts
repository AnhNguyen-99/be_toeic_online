...
describe('Exam Service', () => {
  ...
  beforeEach(() => {
    ...
    elemDefault = {
      id: 0,
      beginExam: currentDate,
      durationExam: 0,
      finishExam: currentDate,
      questionData: 'AAAAAAA',
      subjectCode: 'AAAAAAA',
      title: 'AAAAAAA',
      status: false,
  ...
  describe('Service methods', () => {
    it('should find an element', () => {
      const returnedFromService = Object.assign(
        {
          beginExam: currentDate.format(DATE_TIME_FORMAT),
          finishExam: currentDate.format(DATE_TIME_FORMAT),
    ...
    describe('addExamToCollectionIfMissing', () => {
      ...
      it('should add only unique Exam to an array', () => {
        const examArray: IExam[] = [{ id: 123 }, { id: 456 }, { id: 16909 }];
