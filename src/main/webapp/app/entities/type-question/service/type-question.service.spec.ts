  ...
  describe('Service methods', () => {
    ...
    describe('addTypeQuestionToCollectionIfMissing', () => {
      it('should add a TypeQuestion to an empty array', () => {
        ...
        expectedResult = service.addTypeQuestionToCollectionIfMissing([], typeQuestion);
      ...
      it('should not add a TypeQuestion to an array that contains it', () => {
        ...
        expectedResult = service.addTypeQuestionToCollectionIfMissing(typeQuestionCollection, typeQuestion);
      ...
      it('should add only unique TypeQuestion to an array', () => {
        const typeQuestionArray: ITypeQuestion[] = [{ id: 123 }, { id: 456 }, { id: 23395 }];
        const typeQuestionCollection: ITypeQuestion[] = [{ id: 123 }];
        expectedResult = service.addTypeQuestionToCollectionIfMissing(typeQuestionCollection, ...typeQuestionArray);
      ...
      it('should accept varargs', () => {
        ...
        expectedResult = service.addTypeQuestionToCollectionIfMissing([], typeQuestion, typeQuestion2);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(typeQuestion);
      ...
      it('should accept null and undefined values', () => {
        const typeQuestion: ITypeQuestion = { id: 123 };
        expectedResult = service.addTypeQuestionToCollectionIfMissing([], null, typeQuestion, undefined);
        expect(expectedResult).toHaveLength(1);
        expect(expectedResult).toContain(typeQuestion);
      });
      ...
      it('should return initial array if no TypeQuestion is added', () => {
        const typeQuestionCollection: ITypeQuestion[] = [{ id: 123 }];
        expectedResult = service.addTypeQuestionToCollectionIfMissing(typeQuestionCollection, undefined, null);
