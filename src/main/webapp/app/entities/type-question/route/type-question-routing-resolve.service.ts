...
export class TypeQuestionRoutingResolveService implements Resolve<ITypeQuestion> {
  constructor(protected service: TypeQuestionService, protected router: Router) {}
