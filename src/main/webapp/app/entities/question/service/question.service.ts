...
export class QuestionService {
  ...
  protected convertDateFromClient(question: IQuestion): IQuestion {
    return Object.assign({}, question, {
      createDate: question.createDate?.isValid() ? question.createDate.toJSON() : undefined,
      updateDate: question.updateDate?.isValid() ? question.updateDate.toJSON() : undefined,
    });
  }
  ...
  protected convertDateArrayFromServer(res: EntityArrayResponseType): EntityArrayResponseType {
    if (res.body) {
      res.body.forEach((question: IQuestion) => {
        ...
        question.updateDate = question.updateDate ? dayjs(question.updateDate) : undefined;
      });
    }
    return res;
  }
